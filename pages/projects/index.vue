...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'A searchable archive of selected web, platform, GIS, commerce, booking and product work by Zhassulan Serikuly.',
    },
  ],
});
</script>
    ...
    <section class='projects_page__hero wrap'>
      <div v-reveal class='projects_page__heading'>
        ...
        <h1 class='projects_page__title'>
          The builds behind<br />
          the notebook.
        </h1>
      </div>

      <p v-reveal class='projects_page__intro'>
        Search by project name, what it does, or any technology in its stack.
        The home page stays curated; this page is the wider archive.
      </p>
    </section>
      ...
      <label class='projects_page__select'>
        ...
        <select v-model='active_category'>
          <option v-for='category in categories'
            :key="category"
            :value="category" v-text='category'></option>
        </select>
      </label>
      ...
      <label class='projects_page__select'>
        ...
        <select v-model='active_stack'>
          <option v-for='stack in stacks'
            :key="stack"
            :value="stack" v-text='stack'></option>
        </select>
      </label>
